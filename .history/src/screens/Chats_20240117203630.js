...
const Chats = ({navigation}) => {
  ...
  const handleSearch = (search) => {
    setSearch(search);
    const filtered = filteredUsers.filter((user) => user
    .fullName.toLowerCase().in)
  }
            ...
            <View>
              <TouchableOpacity
                style={{
                  ...
                  height: 20,
                  borderRadius: 10,
                  backgroundColor: item.messsagesInQueue
                    ? COLORS.primary
                    : 'transparent',
                ...
                <Text style={styles.messsagesInQueue}>
                  {item.messsagesInQueue}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
